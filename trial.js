...
//
// var CC =document.getElementsByName("formA").date.value;
...
//
// function validation(){
//   if (document.formA.century.value==""){
//     alert("the centuryis invalid");
//     return false;
//   }
//   else if (document.formA.year.value=="") {
//     alert("the year is invalid");
//     return false;
//   }
//   else if (document.formA.month.value=="" ) {
//     alert("the month is invalid");
//     return false;
//   }
//   else if (document.formA.date.value=="") {
...
//     var MM =document.getElementsByName("month").value;
//     var DD =document.getElementsByName("date").value;
//     var dayOfTheWeek= ( ( (CC/4) -2*CC-1) + ((5*YY/4) ) + ((26*(MM+1)/10)) + DD-1)%7;
